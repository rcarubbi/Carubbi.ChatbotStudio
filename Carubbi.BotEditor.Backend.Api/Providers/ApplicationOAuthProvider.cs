...
namespace Carubbi.BotEditor.Backend.Api.Providers
{
    public class ApplicationOAuthProvider : OAuthAuthorizationServerProvider
    {
        ...
        public ApplicationOAuthProvider(string publicClientId, UserService userService)
        {
        ...
        public override async Task GrantResourceOwnerCredentials(OAuthGrantResourceOwnerCredentialsContext context)
        {
            ...
            ClaimsIdentity oAuthIdentity = await user.GenerateUserIdentityAsync(_userService,
               OAuthDefaults.AuthenticationType);
            ClaimsIdentity cookiesIdentity = await user.GenerateUserIdentityAsync(_userService,
